...
RSpec.describe Ticket do
  describe 'fields' do
    ...
    it { is_expected.to have_db_column(:sequance_number).of_type(:integer).with_options(null: false) }
    ...
    it { is_expected.to have_db_column(:primary_service_aria_code).of_type(:string).with_options(null: false) }
